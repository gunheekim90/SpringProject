									...
									<div class="row">
										...
										<div class="col-md-5 col-sm-6">
											...
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit diam nec augue semper,in dignissim elit hendrerit. Lorem ipsum dolor sit amet. </p>	
												...
												<form action="step2" method="POST" class="padd-tb-10" >
													<div class="row">
													...
													<div id="success"></div>
													<div class="padd-t-10">
													<button type="submit" onclick="window.location.href='/sp4-chap13/register/step2'" class="btn btn-success btn-block btn-lg">REGISTER NOW!</button>
													</div>
												</form>
