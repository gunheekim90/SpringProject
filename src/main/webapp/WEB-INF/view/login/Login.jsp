					...
					<div class="widget">
						<!-- Working Contact Form -->
							...
							<div class="padd-tb-10">
								<button type="submit" class="btn btn-success btn-lg btn-block">Login with Email</button>
							</div>	</br></br>
							<a class="btn btn btn-block btn-social btn-facebook">
								  <span class="fa fa-facebook"></span>
								  Sign in with Twitter
							</a> </br>
								<a class="btn btn btn-block btn-social btn-twitter">
								  <span class="fa fa-twitter"></span>
								  Sign in with Twitter
							</a> </br>
								<a class="btn btn btn-block btn-social btn-google">
